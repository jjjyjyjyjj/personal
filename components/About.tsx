...
// const About: FC = () => (
//   <section id="about" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", minHeight:"100vh" }}>

//     {/* ── Image col ── */}
//     <div style={{ background:T.parchment, position:"relative", overflow:"hidden", minHeight:"100vh" }}>
//       <AboutPetals />
//     </div>

//     {/* ── Text col ── */}
//     <div className="reveal" style={{ paddingLeft:" 5rem", paddingRight:" 5rem", paddingTop: "100px", display:"flex", flexDirection:"column", justifyContent:"center", position:"relative", minHeight:"100vh" }}>
...
//         3. Entertain us
//         <br /><br/>
//         Outside of the classroom, I've spent the past few years running a small business selling handmade jewelry. I also like drawing, going to the gym and staring at ugly animals on the street.
//         <br /><br/>
//         I've always been fascinated by the intersection of technology and design, and I'm constantly looking for fresh ways to bring those two worlds together.
//       </p>
//       {/* interests row */}
...
//           <div key={item} style={{ paddingRight: i < arr.length - 1 ? "2rem" : 0, borderRight: i < arr.length - 1 ? `1px solid ${T.parchment}` : "none", marginRight: i < arr.length - 1 ? "2rem" : 0 }}>
...
const About: FC = () => {
  ...
  return (
    <section id="about" className="about-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr", minHeight:"100vh" }}>
